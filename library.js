...
while(ch==1){
  let operation=prompt("Adding_books/ Borrowing_books/ Returning_books/ List_Available_book/ Search_Book ");
    switch (operation) {
    case 'Adding_books':
     Adding_books(ch);
      break;
    ...
    case 'List_Available_book':
      ...
      break;
      case 'Search_Book':
        let title_=prompt("choose from available book title:eng, hindi, maths, science, computer ");
